<template>
    <div class="container">
      ...
      <!-- ปุ่มเพิ่มกีฬา -->
      <p>
        <button class="btn success" v-on:click="navigateTo('/blog/create')">
          เพิ่มกีฬา
        </button>
      </p>
      ...
      <div v-for="blog in blogs" :key="blog.id" class="blog-card">
        ...
        <p class="actions">
          <button class="btn warning" v-on:click="navigateTo('/blog/edit/' + blog.id)">
            แก้ไขข้อมูล
          </button>
          <button class="btn danger" v-on:click="deleteBlog(blog)">
            ลบข้อมูล
          </button>
        </p>
        <hr />
